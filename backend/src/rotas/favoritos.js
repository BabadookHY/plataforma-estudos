...
router.delete("/remover/:conteudo_id", autenticar, async (req, res) => {
  ...
  // Pegar o id do usuário responsável pelo post
  ...
  // Compara se o id do usuário responsável pelo conteúdo é o mesmo que está logado
  if (user.data.id !== data.criado_por) {
    return res
      .status(401)
